...
if __name__ == "__main__":
    ...
    # task dataset
    Disk_Train = ToyDiskDataset(data_path='./data/disk/TwentyfiveDistractors/', filename='toy_pn=2.0_d=25_const',
                                # threeDistractors_400, toy_pn=0.1_d=3_const; Skewt_15Distr_400
                                datatype="train_data")
    Disk_Val = ToyDiskDataset(data_path='./data/disk/TwentyfiveDistractors/', filename='toy_pn=2.0_d=25_const',
