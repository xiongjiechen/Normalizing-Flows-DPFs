...
def get_run_id(args):
    cnt = '{}_{}_{}_{}_{}_{}_{}'.format(args.seed,args.NF_cond,args.trainType,args.pos_noise,args.vel_noise,args.NF_lr,args.lr)
    return cnt
...
if __name__ == "__main__":
    ...
    # task dataset
    Disk_Train = ToyDiskDataset(data_path='./data/disk/TwentyfiveDistractors/', filename='toy_pn=0.1_d=25_const',
                                # threeDistractors_400, toy_pn=0.1_d=3_const; Skewt_15Distr_400
                                datatype="train_data")
    Disk_Val = ToyDiskDataset(data_path='./data/disk/TwentyfiveDistractors/', filename='toy_pn=0.1_d=25_const',
    ...
    Disk_Test = ToyDiskDataset(data_path='./data/disk/TwentyfiveDistractors/', filename='toy_pn=0.1_d=25_const',
                               # threeDistractors_400, toy_pn=0.1_d=3_const
                               datatype="test_data")
    test_loader = DataLoader(Disk_Test, batch_size=50, shuffle=False, drop_last=True)

    dpf.testing(test_loader, run_id=run_id)
